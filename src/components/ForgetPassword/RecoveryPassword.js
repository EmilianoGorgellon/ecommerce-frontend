...
import { recovery_password } from "../../services/user_services";
import {BiUser} from "react-icons/bi";
const RecoveryPassword = (props, params) => {
                ...
                <div className='login'>
                    ...
                    <Formik
                        ...
                        onSubmit= {async (values) => {
                            ...
                            const response = await recovery_password(props.email, values.code, values.new_password);
                            console.log("Veo proprs");
                            if (response === true) return setRedirectPage(true);
