  ...
  return (
    <main>
        ...
        <Formik 
            ...
            validate={(values) => {
                let errors = {};
                if (!VALIDATION.name.test(values.name)) errors.name = `El nombre del producto puede tener letras, numeros y debe ser minimo a 3 caracteres` 
     
                if (!VALIDATION.description.test(values.description)) errors.description = `La descripcion del producto no puede ser mayor a 150 caracteres`
